...
public class TopTitleBar extends ViewGroup implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        mLeftText.setText(R.string.back);
    ...
    public void setLeftTextPadding() {
    ...
    public void setTitle(CharSequence title) {
        ...
        if (index > 0) {
            setTitle(title.subSequence(0, index), title.subSequence(
                    index + 1, title.length()), LinearLayout.VERTICAL);
        } else {
    ...
    /**
     * set the custom title view by developer
     *
     * @param titleView
     */
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        mRightLayout.layout(
                mScreenWidth - mRightLayout.getMeasuredWidth(), mStatusBarHeight, mScreenWidth,
        ...
        mDividerView.layout(0, getMeasuredHeight() -
                mDividerView.getMeasuredHeight(), getMeasuredWidth(), getMeasuredHeight());
    }
    ...
    public static abstract class ImageAction implements Action {
        ...
        public int getBackground() {
            return 0;
            // return R.drawable.title_item_selector;
        }
    }
